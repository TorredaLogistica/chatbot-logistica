...
def render_metricas_sla(sla_dict: dict, lista_titulo: str, coluna: str):
    ...
    for col, (label, value_dict) in zip([c1, c2, c3], sla_dict.items()):
        ...
        if coluna == 'Empresa' and label == 'D+1':
            linhas_html += '<div class="metric-line" style="font-weight:800;border-bottom:1px solid #e6e6e6;padding-bottom:4px;margin-bottom:4px;"><span class="metric-name">Empresa</span><span class="metric-pct">SLAAA</span><span class="metric-pct">Meta</span></div>'
