...
st.markdown(
    ...
    /* Ajuste específico solicitado para Visão Empresas D+1 */
    ...
    .metric-col-sla, .metric-col-sla-head,
    .metric-col-meta, .metric-col-meta-head {
        justify-self: center;
        width: 100%;
    }
    ...
    @media (max-width: 768px) {
        ...
        .metric-line-empresa-head,
        .metric-line-empresa { grid-template-columns: minmax(0, 1fr) 72px 72px; gap: 6px; }
    }
